...
export interface State {
     ...
     * There are two special state keys when a widget has layouts:
     *  - hiddenLayoutIds: The layout ids that are hidden, it's an array of string.
     *  - hiddenLayoutItems: The layout items that are hidden, it has this format:
