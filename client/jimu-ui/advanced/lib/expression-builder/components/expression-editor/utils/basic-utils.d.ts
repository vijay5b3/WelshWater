import { type ExpressionPart, type ImmutableArray, type UseDataSource, type IMUseDataSource, type BrowserSizeMode } from 'jimu-core';
...
export declare function getSortedKeys(obj: {
    [key: string]: unknown;
}): string[];
export declare function getPartIdByIndex(externalId: string, index: number): string;
export declare function getIndexByPartId(externalId: string, partId: string): number;
export declare function getInternalId(externalId: string, id: string): string;
 ...
 * e.g., 123 -> 123A (one number part -> one unknown part)
 ...
 *
 * unmergeable part should have a special character or stable pattern, to mark the start of the part and the end of the part,
...
export declare function isOrder(exp: string): boolean;
