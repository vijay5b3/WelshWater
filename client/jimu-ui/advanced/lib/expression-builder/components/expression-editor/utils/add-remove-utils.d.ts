 ...
 */
export declare function addCharactersToParts(externalId: string, parts: ExpressionPart[], newCharacters: string, isInEditablePart: boolean, range: Range, nextNodeOfSelection: HTMLElement): EditResult;
